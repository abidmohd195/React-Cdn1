...
const MyfirstReact = () => {
  return (
    <div id="main container" style={{margin:20,color:white}}>
      <hr></hr>
...
ReactDOM.render(<MyfirstReact />, document.querySelector("#root"));
